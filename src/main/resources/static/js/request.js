...
function init(){
	...
	docTitleListSelectShow('docTitle2','docTitleList2');
	docTitleListSelectShow('docTitle3','docTitleList3');
	docTitleListSelectShow('docTitle4','docTitleList4');
	docTitleListSelectShow('docTitle5','docTitleList5');
	docTitleListSelectShow('docTitle6','docTitleList6');
	docTitleListSelectShow('docTitle7','docTitleList7');
	docTitleListSelectShow('docTitle8','docTitleList8');
}
...
//    	      "</table>";
    	   ...
    	   var appendHtml =
    	      ...
    	      "<div class='ds-row ds-margin-top-sm-1 ds-margin-bottom-sm-1 ds-margin-top-md-0 ds-margin-bottom-md-0'>"+
 	 	      ...
 	 	      "</div>"+
     	      "<div class='ds-row ds-margin-top-sm-1 ds-margin-bottom-sm-1 ds-margin-top-md-0 ds-margin-bottom-md-0'>"+
 	 	        "<div class='ds-col-md-3'><div class='ds-input-container ds-margin-bottom-2 ds-display-inline'><span>第二検証者ID：</span></div></div>"+
 	 	      	"<div class='ds-col-md-9 ds-margin-bottom-1 ds-align-text-left  '><span>"+vali2IdStr+"</span></div>"+
 	 	      "</div>"+
    	      "<div class='ds-row ds-margin-top-sm-1 ds-margin-bottom-sm-1 ds-margin-top-md-0 ds-margin-bottom-md-0'>"+
 	 	      	"<div class='ds-col-md-3'><div class='ds-input-container ds-margin-bottom-2 ds-display-inline'><span>受付窓口ID：</span></div></div>"+
 	 	      	"<div class='ds-col-md-9 ds-margin-bottom-1 ds-align-text-left  '><span>"+receptionIdStr+"</span></div>"+
 	 	      "</div>";
